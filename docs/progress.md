...
| 2026-09-11 | Chore | Shell-функция `tolmach` запускает Claude Code на модели `claude-sonnet-5` вместо `claude-sonnet-4-5-20250929` (setup.sh + уже установленная функция в ~/.zshrc) | — |
